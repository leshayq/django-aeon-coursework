...
from .views import ProductDetailView, IndexView, RateView, CategoryListView, WishListView, add_to_wishlist, remove_from_wishlist, search_items, contact_us_view, about_us_view
app_name = 'shop'
